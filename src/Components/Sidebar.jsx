...
const Sidebar = ({ isExpanded, toggleMenu, links }) => {
    ...
    return (
        <div className="px-3 pt-5 space-y-3">
            ...
            <button onClick={logout} className={`${isExpanded ? 'lg:justify-center' : ''} w-full hover:bg-blue-100 text-gray-700 flex flex-row place-items-center gap-3 rounded-md px-3 py-2 transition duration-300 ease-in-out`}>
